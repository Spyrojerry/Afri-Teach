...
export const CallToAction = () => {
  return (
    <section className="py-16 md:py-20 bg-gradient-to-br from-emerald-600 via-emerald-700 to-blue-800 text-white relative overflow-hidden">
      {/* Background Pattern */}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            <div className="flex flex-col items-center">
              ...
              <div className="text-emerald-200 text-sm">Verified Teachers</div>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-emerald-200 text-sm">Lessons Completed</div>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-emerald-200 text-sm">African Countries</div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              size="lg" 
              className="bg-white text-emerald-700 hover:bg-emerald-50 px-8 py-4 text-lg font-medium group"
            >
              Start Learning Now
          ...
          <div className="mt-12 pt-8 border-t border-white/20">
            <p className="text-emerald-200 text-sm mb-4">Trusted by students worldwide</p>
